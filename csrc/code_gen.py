...
def main():
    ...
    output_dir.write_text(header + array_code_gen(string_to_array(had_12_paley)) + array_code_gen(string_to_array(had_20_paley)) + array_code_gen(string_to_array(had_28_paley)) + array_code_gen(string_to_array(had_40_tpal)))
